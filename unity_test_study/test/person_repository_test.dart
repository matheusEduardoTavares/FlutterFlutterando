...
void main() {
  ...
  ///Esse teste depende da internet. O 
  ///ideal é testes de unidade não dependerem
  ///de nada externo, então o ideal é mockarmos
  ///a resposta no caso de acesso à APIs,
  ...
  test('deve pegar uma lista de Person requisitando à API', () async {
    ...
    expect(list.first.name, equals('Xander Lendner'));
  });

  test('deve pegar uma lista de Person através dos mocks', () async {
  ...
  test('Retorna uma exception se não for statusCode 200', () {
    when(() => client.get(any())).thenAnswer((invocation) async => Response(
      'not found',
      404, 
    ));
